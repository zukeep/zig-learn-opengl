...
var horizontalOffset: f32 = 0.5;

// bonus: offset the triangle vertically as well
var verticalOffset: f32 = 0.0;
...
fn processInput(window: glfw.Window) void {
    ...
    // bonus: you can move the triangle around with the arrow keys
    if (window.getKey(.left) == glfw.Action.press) {
        horizontalOffset -= 0.001;
    }
...
pub fn main() !void {
    ...
    // compile shaders
    var shaders = try util.NewShader("getting_started_shaders_vertex_ex2.glsl", "getting_started_shaders_fragment.glsl");
    ...
    while (!window.shouldClose()) {
        ...
        shaders.use();
        shaders.setFloat("horizontalOffset", horizontalOffset);
        shaders.setFloat("verticalOffset", verticalOffset);
